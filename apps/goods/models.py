...
class GoodsCategoryBrand(models.Model):
    ...
    image = models.ImageField(max_length=200, upload_to="brands/")   # media目录下的子路径
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=1000, height=300, filePath="goods/files/", default='')  #富文本编辑框
